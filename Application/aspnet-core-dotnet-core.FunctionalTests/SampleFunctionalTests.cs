        ...
        public void SampleFunctionalTest2()
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    Assert.AreEqual("Azure DevOps Project has been successfully setup in Staging V8.0.0", driver.FindElementByCssSelector("div[class='description line-1']").Text, "Expected description line  to be 'Azure DevOps Project has been successfully setup in Staging V6.0.0'");
